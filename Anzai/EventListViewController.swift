...
//  Anzai
//
//  Created by MIGGI on 2017/02/18.
...
//        eventArray.append(event)
        let apiCon:APIConnector =
            APIConnector(activity: self, type: 1, object: myId)
        apiCon.execute()
    }
    ...
    func tableView(_ tableView: UITableView, didSelectRowAt indexPath: IndexPath)
    {
        ...
        performSegue(withIdentifier: "callDetailEventView", sender: self)
    ...
    override func prepare(for segue: UIStoryboardSegue, sender: Any?) {
        ...
        if segue.identifier == "callDetailEventView"{
